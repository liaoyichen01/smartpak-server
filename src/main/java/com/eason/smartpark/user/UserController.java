package com.eason.smartpark.user;
...
public class UserController {
	...
	@RequestMapping(value = "user", method = RequestMethod.POST)
	public ResponseEntity<JsonResult> login(@RequestBody User user, HttpSession session){
		JsonResult r = new JsonResult();
		try {
			int ret = -1;
